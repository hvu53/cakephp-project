				...
				<div class="f-left"><?php echo $this->Html->link(
					...
					array('escape' => false)
							...
							<ul id="header-nav">
									...
									<li ><?php echo $this->Html->link('my account',array('controller'=>'users','action'=>'index'));?></li>
							</ul>
							
							
							<ul id="nav">
					<li>
						<?php echo $this->Html->link('Home', '#', array('title' => 'Xamples - free samples, professional survey, market testing')); ?>
					</li>
					<li>
						<?php echo $this->Html->link('How we work', '#', array('title' => 'Cut the cost with xamples')); ?>
					</li>
					<li>
						<?php echo $this->Html->link('Fragrance', '#', array('title' => 'Free Fragrance Samples')); ?>
					</li>
					<li class="current"><a href="#">Baby&amp;child</a></li>
				</ul>
...
<noscript>
	...
	<div id="mini-cart" class="box padded">
		<div style="text-align: center;"><h3>My Shopping Bag<a href="#" class="f-right close-mini-cart">X</a></h3></div>
		
		<ul class="items clear-float">
			<?php
				//echo $this->element('minicart-items', array('products' => array()));
				?>
		</ul>
		<a href="#" class="f-left close-mini-cart"><h4>Keep shopping</h4></a>
		<a href="#" class="f-right"><h4>Checkout</h4></a>
	</div>
...
<script type="text/javascript">
    $(function() {
		...
		$('.close-mini-cart').click(function(){
			$('#mini-cart').animate({opacity: 'hide','top':'50px'});
		});
	});
</script>
