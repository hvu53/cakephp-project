		...
		<div id="header">
			<div class="main-column">
				<div class="f-left"><?php echo $this->Html->link(
					$this->Html->image('logobusiness.png', array('alt'=> 'xamples - cut the cost')),
					'/',
					array('escape' => false)
				); ?></div>
							<ul id="header-nav"> 
								<li>
						<?php echo $this->Html->link('Home', array('business'=>true,'controller'=>'pages','action'=>'display','introduction')); ?>
					</li>
					<li>
						<?php echo $this->Html->link('Our Services', array('business'=>true,'controller'=>'pages','action'=>'display','services')); ?>
					</li>
					<li>
						<?php echo $this->Html->link('Contact Us',array('business'=>true,'controller'=>'pages','action'=>'display','contact_us')); ?>
					</li>
									
									<li>
										<?php echo $this->Html->link(
											'Sign In',
											array('business'=>false,'controller' => 'users', 'action' => 'login')
											); ?>
									</li>
								<li>
										<?php echo $this->Html->link(
											'Main Site',
											array('business'=>false,'controller' => 'products', 'action' => 'index')
											); ?>
									</li>
							</ul>
